import {EventDispatcher, Quaternion, Vector3} from './three.module.js';
...
class FlyControls extends EventDispatcher {
  ...
  constructor(object, domElement) {
    ...
    this.update = function(delta) {
      ...
      scope.tmpQuaternion
          .set(scope.rotationVector.x * rotMult,
               scope.rotationVector.y * rotMult,
               scope.rotationVector.z * rotMult, 1)
          .normalize();
    ...
    this.updateMovementVector = function() {
      ...
      // console.log( 'move:', [ this.moveVector.x, this.moveVector.y,
      // this.moveVector.z ] );
    };
    ...
    this.updateRotationVector = function() {
      ...
      // console.log( 'rotate:', [ this.rotationVector.x, this.rotationVector.y,
      // this.rotationVector.z ] );
    };
