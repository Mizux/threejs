...
function init() {
  ...
  material = new THREE.MeshBasicMaterial( { color:'#808080', wireframe:true, transparent:true } );
  ...
  material = new THREE.MeshBasicMaterial( { color:'#F0F0F0', side:THREE.DoubleSide } );
