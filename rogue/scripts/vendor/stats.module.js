  ...
  begin() {
    ...
    if (time >= this.#prevTime + 1000) {
      this.#fpsPanel.update(
          (this.#frames * 1000) / (time - this.#prevTime), 100);
      this.#prevTime = time;
      this.#frames = 0;
      ...
      if (this.#memPanel) {
        ...
        this.#memPanel.update(
            memory.usedJSHeapSize / 1048576, memory.jsHeapSizeLimit / 1048576);
      }
    }
    return time;
  }
...
class Panel {
  ...
  constructor(name, fg, bg) {
    ...
    this.context.fillRect(
        Panel.GRAPH_X, Panel.GRAPH_Y, Panel.GRAPH_WIDTH, Panel.GRAPH_HEIGHT);
  ...
  update(value, maxValue) {
    ...
    this.context.drawImage(
        this.canvas, Panel.GRAPH_X + Panel.PR, Panel.GRAPH_Y,
        Panel.GRAPH_WIDTH - Panel.PR, Panel.GRAPH_HEIGHT, Panel.GRAPH_X,
        Panel.GRAPH_Y, Panel.GRAPH_WIDTH - Panel.PR, Panel.GRAPH_HEIGHT);
