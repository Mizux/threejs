...
const plane_material =
    new THREE.MeshPhongMaterial({color : '#101010', flatShading : false});
...
// const unit_cube_material = new THREE.MeshPhongMaterial({ color: '#101010',
// flatShading: false });
...
const params = {
  ...
  model : {id : 0, rotation : {x : 0.003, y : 0.005, z : 0.007}}
};
...
sceneAxesHelperGUI.add(params.scene.axesHelper, 'visible')
...
sceneUnitCubeGUI.addColor(params.scene.unit_cube, 'color')
    .onChange(updateParams);
// sceneGUI.open();
